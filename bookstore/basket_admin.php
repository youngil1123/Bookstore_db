...
$id=$_POST["id"];
$stationery_no = $_POST['stationery_no'];
$gift_no = $_POST['gift_no'];
$domestic_no = $_POST['domestic_no'];
$foreign_no = $_POST['foreign_no'];
...
<body>
    ...
    <table>
        <tr>
            ...
            <td>
                <form name="account" method="post" action='pay_progress_admin.php'>
